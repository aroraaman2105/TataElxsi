...
export default function PersonaBanner() {
  ...
  return (
    <motion.div
      ...
      className="mb-6 rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 sm:px-5 sm:py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2"
      style={{ borderLeftWidth: 3, borderLeftColor: personaConfig.accent }}
    >
      <div>
        <p className="text-[10px] uppercase tracking-wider text-slate-500 font-semibold">Active workspace</p>
